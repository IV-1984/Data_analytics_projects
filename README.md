...
| 5. [Lyrics_analysis](https://github.com/IV-1984/Data_analytics_projects/blob/main/5.%20lyrics%20analysis/Project_Pesni_final.ipynb) | BeautifulSoup, nltk, wordcloud, pandas  | Небольшой проект по парсингу,  обработке и анализу текстовых файлов(тексты песен).
